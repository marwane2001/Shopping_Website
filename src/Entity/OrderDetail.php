...
class OrderDetail
{
    ...
    #[ORM\Column(length: 255)]
    private ?string $prodcutIllustration = null;
    ...
    public function getProdcutIllustration(): ?string
    {
        return $this->prodcutIllustration;
    }

    public function setProdcutIllustration(string $prodcutIllustration): static
    {
        $this->prodcutIllustration = $prodcutIllustration;
